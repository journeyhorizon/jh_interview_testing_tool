    ...
    return (
      <div className={css.controlPanel}>
        ...
        <div className={css.reviews}>
          ...
          <textarea className={css.reviewsContent} name="reviews" value={this.props.resultOfTest.reviews} placeholder={"Write down your reviews here..."} onChange={this.props.giveReviewsAndScores} />
        </div>
